...
- **Schedule** stays 07:30 generation with --require-freshness and 07:45 evaluation, Europe/Helsinki. Publication-order-only recovery can overwrite current statistics and recheck the full gate on a non-dry run; missing EEX readiness blocks recovery. No new deployment generation or schedule is added.
