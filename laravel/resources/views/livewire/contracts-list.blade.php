            ...
            <div class="flex flex-col px-4">
                ...
                <div class="flex flex-col lg:flex-row gap-2">
                    @foreach ($contractTypes as $type => $label)
                        @php
                            $icons = [
                                'open_ended' => 'M13 5l7 7-7 7M5 5l7 7-7 7',
                                'fixed' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
                            ...
                            $icon = $icons[$type] ?? $icons['open_ended'];
                        @endphp
                        <button
