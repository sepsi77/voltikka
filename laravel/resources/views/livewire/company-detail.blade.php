<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Back Link -->
    <a href="/" class="inline-flex items-center text-primary-600 hover:text-primary-800 font-medium mb-6">
        ...
        <div class="flex flex-col lg:flex-row items-center lg:items-start gap-6">
            ...
            @else
                <div class="w-32 h-16 bg-gray-200 rounded flex items-center justify-center">
                    <span class="text-gray-500 text-lg font-bold">{{ substr($company->name, 0, 3) }}</span>
                </div>
            @endif
    ...
    <div class="space-y-4">
                ...
                @if ($source)
                    <div class="flex flex-wrap gap-2 mt-4">
                        @if ($source->renewable_total && $source->renewable_total > 0)
                            <span class="text-gray-700 border border-green-700 bg-[#E4FFC9] font-medium rounded-lg text-sm px-3 py-1">
                        ...
                        @if ($source->fossil_total && $source->fossil_total > 0)
                            <span class="text-gray-700 border border-gray-700 bg-gray-100 font-medium rounded-lg text-sm px-3 py-1">
        ...
        @empty
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
                <p class="text-gray-500">Ei sähkösopimuksia saatavilla.</p>
            </div>
        @endforelse
    </div>
</div>
