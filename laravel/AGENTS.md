...
- `/sahkosopimus/tilastot` serves cached prepared view data per period + consumption. Its v14 key and source fingerprint include the configured active annual method. Production has used `annual_cost_as_of_v1` since 2026-08-09; legacy rows remain for rollback
