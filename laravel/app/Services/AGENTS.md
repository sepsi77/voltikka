...
- annual list/company/ranking keys include the Helsinki calculation date, with instance memo refresh at midnight and data-version changes. Shared calculated-cost schema v17 invalidates pricing semantics, not historical rows
