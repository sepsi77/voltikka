...
readonly class ResetEstimateRequest
{
     ...
     * @param  CarbonImmutable  $asOfDate  Window start. Also the single curve-vintage anchor:
     *                                     every lookup uses the latest `trade_date < asOfDate`.
     ...
     *                                               floor and the plausibility band.
