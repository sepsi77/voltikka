...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', env('APP_NAME', 'Voltikka')),
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => env('BACKUP_FILENAME_PREFIX', 'voltikka-'),
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                ...
                \Spatie\Backup\Tasks\Monitor\HealthChecks\MaximumStorageInMegabytes::class => env('BACKUP_MAX_STORAGE_MB', 10000),
            ],
        ],
