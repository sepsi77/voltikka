...
Fresh current data passed before the operation. Deployment `bcb5a9e7-2b88-4841-a97c-08708d990eb9` succeeded, and cached public v2, protected hashes, core readers, and unit/index isolation passed. The public CSV export exceeds its 30-second runtime after the added history; its separate fix and release remain open. See `activation-results.md`. Do not issue an automatic rollback or further production mutation without approval.
