...
config()->set('contract_interpretation.prompt_path', __DIR__.'/'.basename((string) ($metadata['prompt'] ?? 'system-prompt-v14.md')));
config()->set('contract_interpretation.model', $metadata['models'][0] ?? config('contract_interpretation.model'));
config()->set('contract_interpretation.reasoning_effort', $metadata['reasoning_effort'] ?? 'medium');
