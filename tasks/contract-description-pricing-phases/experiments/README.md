...
- `system-prompt-v11.md` — recommended prompt with flat-input, scalar evidence, pricing invariants, strict package components, warning consistency, conservative Hybrid fallback, recurring completeness, and analysis-date cutoff rules
...
python3 tasks/contract-description-pricing-phases/experiments/run_experiment.py \
  --run-name top100-gpt-v11-low-rerun \
  --prompt system-prompt-v11.md \
...
php tasks/contract-description-pricing-phases/experiments/repair_run.php \
  tasks/contract-description-pricing-phases/experiments/runs/top100-gpt-v11-low-rerun \
  2
```
