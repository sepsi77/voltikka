...
- `system-prompt-v15.md` — recommended prompt with opaque contract IDs, flat-input, scalar evidence, pricing invariants, active-discount gating, included-energy and excess-use package components, warning consistency, structured-only completeness, conservative Hybrid fallback, recurring completeness, and analysis-date cutoff rules
...
python3 tasks/contract-description-pricing-phases/experiments/run_experiment.py \
  --run-name top100-gpt-v15-medium-rerun \
  --prompt system-prompt-v15.md \
...
php tasks/contract-description-pricing-phases/experiments/repair_run.php \
  tasks/contract-description-pricing-phases/experiments/runs/top100-gpt-v15-medium-rerun \
  2
```
