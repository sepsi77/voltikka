...
- Kept annualized savings labels as estimates where annualized values are shown, but removed awkward wording such as “top 3:ssa” and “€/kWh-luku”.
...
- Keep the ranking table internally consistent: `Jakson hinta` and `Säästö jaksolta` are both based on the entered billing period and kWh. Annualized €/kk savings stay in the verdict hero, not per table row.
